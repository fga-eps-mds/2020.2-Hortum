...
class Announcement(models.Model):
    ...
    FLORES = [
        ...
        ('Bromélias - Aechemea', 'Bromélias - Aechemea'),
        ('Bromélias - Cryptanthus', 'Bromélias - Cryptanthus'),
        ('Bromélias - Neoregelia', 'Bromélias - Neoregelia'),
        ('Buxinho', 'Buxinho'),
        ...
        ('Flores comestívies - Brinco de princesa', 'Flores comestívies - Brinco de princesa'),
        ('Flores comestívies - Capuchinha', 'Flores comestívies - Capuchinha'),
    ...
    FRUTAS = [
        ...
        ('Laranja', 'Laranja'),
        ('Limão', 'Limão'),
        ('Longana/Lichia Branca/Olho de dragão', 'Longana/Lichia Branca/Olho de dragão'),
        ('Mamão', 'Mamão'),
        ('Manga', 'Manga'),
        ('Maracujá', 'Maracujá'),
        ('Maracujá Pérola', 'Maracujá Pérola'),
        ('Melancia', 'Melancia'),
        ('Morango', 'Morango'),
        ('Pitaia', 'Pitaia'),
        ('Pitanga', 'Pitanga'),
